...
+ スクリプトにキーボードショートカットを設定できます
  ...
  <img width="655" height="525" alt="SS_CleanShot_08_004372" src="https://github.com/user-attachments/assets/2f45a445-9937-4ecc-96fd-89ca29d132a1" />
...
+ 難読化されたJSX（`.jsxbin`、または先頭が `@JSXBIN` の `.js` / `.jsx` / `.jsxbin`）は、SCRIPTMETA編集できません。右クリックメニューでは「SCRIPTMETA編集（難読化jsx）」として無効表示されます
